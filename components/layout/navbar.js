          ...
          >
            ...
            <div class="offcanvas-body">
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <hr />
                <li class="nav-item pb-2 dropdown fs-5">
                  <a
                  ...
                  >
                    <svg
                      ...
                      height="32"
                      fill="currentColor"
                      class="bi bi-sign-turn-right me-4"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      <Link href="about">
                        <a class="dropdown-item">About Me</a>
                      </Link>
                    </li>
                    <li>
                      <Link href="blog">
        ...
        <div class="container-fluid">
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto">
              ...
              <li class="nav-item">
                <Link href="about">
                  <a class="nav-link fw-bold">ABOUT ME</a>
                </Link>
              </li>
      ...
      <nav class="navbar ms-auto">
        <div class="container-fluid">
          <a
            ...
            class="navbar-brand ms-2 p-1 fw-bold"
            href="#"
          >
            EMAIL ME
          </a>
